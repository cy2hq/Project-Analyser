SELECT B.RECNAME, B.REFNAME, A.OBJECTVALUE1, A.OBJECTVALUE2, A.OBJECTVALUE3, A.OBJECTVALUE4
...
AND B.REFNAME <> ' '
   ...
   AND NOT EXISTS(SELECT 'X' FROM PSDBFIELD C WHERE B.REFNAME = C.FIELDNAME)